...
#define i2c_write(devaddr,regaddr,len,addr) \
        HAL_I2C_Mem_Write(&hi2c1,(devaddr<<1),regaddr,I2C_MEMADD_SIZE_8BIT,addr,len,0x50)
//i2c_read(st.hw->addr, ii, 1, &data)
#define i2c_read(devaddr,regaddr, len, addr) \
        HAL_I2C_Mem_Read(&hi2c1, (devaddr<<1),regaddr, I2C_MEMADD_SIZE_8BIT, addr, len, 0x50)
